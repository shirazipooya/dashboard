...
def toolkits__groundWater__dataVisualization__aquiferHydrograph(server):
    ...
    for view_function in toolkits__groundWater__dataVisualization__aquiferHydrograph__app.server.view_functions:
        if view_function.startswith(toolkits__groundWater__dataVisualization__aquiferHydrograph__app.config.url_base_pathname):
            toolkits__groundWater__dataVisualization__aquiferHydrograph__app.server.view_functions[view_function] = login_required(
                toolkits__groundWater__dataVisualization__aquiferHydrograph__app.server.view_functions[view_function]
            )
