...
def toolkits__groundWater__unitHydrograph(server):
    ...
    for view_function in toolkits__groundWater__unitHydrograph__app.server.view_functions:
        if view_function.startswith(toolkits__groundWater__unitHydrograph__app.config.url_base_pathname):
            toolkits__groundWater__unitHydrograph__app.server.view_functions[view_function] = login_required(
                toolkits__groundWater__unitHydrograph__app.server.view_functions[view_function]
            )
